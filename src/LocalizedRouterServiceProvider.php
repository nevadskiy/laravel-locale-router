...
use Nevadskiy\LocalizedRouter\Controllers\FallbackController;
use Nevadskiy\LocalizedRouter\Middleware\SetLocaleMiddleware;

class LocalizedRouterServiceProvider extends ServiceProvider
{
    /**
